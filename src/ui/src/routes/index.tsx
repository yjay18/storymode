...
import { BookImportDropzone } from "../features/builder/BookImportDropzone";
...
export function BookImportScreen(): React.JSX.Element {
  return <BookImportDropzone />;
}
  ...
  return (
    <AppShell>
      <Routes>
        ...
        <Route path="/builder/import" element={<BookImportScreen />} />
